...
suite('authentication-parameters', function() {
  ...
  test('create-from-header', function(done) {
    var testData = [
      [
        'Bearer authorization_uri="test,lkfj,;l,", fruitcake="f",resource="clark, &^()- q32,shark" , f="foo"',
        {
      ...
      [
        'Bearer authorization_uri=="test,lkfj,;l,", resource="clark, &^()- q32,shark",fruitcake="f" , f="foo"',
        null
      ],
      ...
      [
        'Bearer  f authorization_uri=test,lkfj,;l,", resource="clark, &^()- q32,shark",fruitcake="f" , f="foo"',
        null
      ],
      // Add random letter between 2 and 3 pair.
      [
        'Bearer  authorization_uri=test,lkfj,;l,", a resource="clark, &^()- q32,shark",fruitcake="f" , f="foo"',
        null
      ],
      // Add random letter between 3 and 2 pair.
      [
        'Bearer  authorization_uri=test,lkfj,;l,", resource="clark, &^()- q32,shark",fruitcake="f" a, f="foo"',
        null
      ],
      // Mispell Bearer
      [
        'Berer authorization_uri=test,lkfj,;l,", resource="clark, &^()- q32,shark",fruitcake="f" , f="foo"',
        null
      ],
      // Missing resource.
      [
  ...
  test('create-from-response', function(done) {
    var testData = [
      [
        {
          statusCode : 401,
          headers : { 'www-authenticate' : 'Bearer authorization_uri="test,lkfj,;l,", fruitcake="f",resource="clark, &^()- q32,shark" , f="foo"' }
        },
        {
          'authorizationUri' : 'test,lkfj,;l,',
          'resource' : 'clark, &^()- q32,shark',
      ...
      [
        {
          statusCode : 401,
          headers : { 'www-authenticate' : 'Berer authorization_uri=test,lkfj,;l,", resource="clark, &^()- q32,shark",fruitcake="f" , f="foo"' }
        },
        null
      ],
      [
  ...
  test('create-from-url-happy-path-string-url', function(done) {
    var getResource = nock(testHost)
                       ...
                       .get(testPath)
                       .reply(401, 'foo',
                         { 'www-authenticate' : 'Bearer authorization_uri="test,lkfj,;l,", fruitcake="f",resource="clark, &^()- q32,shark" , f="foo"' }
                       );
