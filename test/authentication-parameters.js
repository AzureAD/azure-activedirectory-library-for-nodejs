...
suite('authentication-parameters', function () {
    ...
    test('create-from-url-happy-path-string-url', function (done) {
        var getResource = nock(testHost)
            ...
            .get(testPath)
            .reply(401, 'test', { 'www-authenticate': 'Bearer authorization_uri="test,lkfj,;l,", fruitcake="f",resource="clark, &^()- q32,shark" , f="test"' });
...
//# sourceMappingURL=authentication-parameters.js.map