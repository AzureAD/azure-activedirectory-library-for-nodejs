...
/**
 * Override AAD API Version.
 * @param {string}  version     Contains the AAD API version that should be used in token request.
 */
AuthenticationContext.prototype.setAADApiVersion = function (version) {
    this._callContext.aadApiVersion = version;
};
