 ...
 * @param {string}   scope                               A URI that identifies the scope for which the token is valid.
 ...
 */
AuthenticationContext.prototype.acquireToken = function(scope, userId, clientId, callback) {
  ...
  this._acquireToken(callback, function() {
    var tokenRequest = new TokenRequest(this._callContext, this, clientId, scope);
 ...
 * @param {AcquireTokenCallback}   callback              The callback function.
 */
AuthenticationContext.prototype.acquireTokenWithAuthorizationCode = function(authorizationCode, redirectUri, scope, clientId, clientSecret, callback) {
  argument.validateCallbackType(callback);
  try {
    argument.validateArrayParameter(scope, 'scope');
  ...
  this._acquireToken(callback, function() {
    var tokenRequest = new TokenRequest(this._callContext, this, clientId, scope, redirectUri);
 ...
 *                                                        to work unchanged.)
 * @param  {string}   scope                               The OAuth scope for which a token is being request.  This parameter is optional and can be set to null.
 * @param  {AcquireTokenCallback}   callback              The callback function.
 */
AuthenticationContext.prototype.acquireTokenWithRefreshToken = function(refreshToken, clientId, clientSecret, scope, callback) {
  ...
  this._acquireToken(callback, function() {
    var tokenRequest = new TokenRequest(this._callContext, this, clientId, actualScope);
