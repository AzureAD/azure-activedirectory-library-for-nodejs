...
WSTrustRequest.prototype._buildSecurityHeader = function() {
  ...
  if (this._wstrustEndpointVersion === WSTrustVersion.WSTRUST2005) {
    ...
    securityHeaderXml = 
    '<wsse:Security soap:mustUnderstand=\'1\' xmlns:wsse=\'http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd\' xmlns:wsu=\'http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd\'>\
    <wsu:Timestamp wsu:Id=\'uuid-' + guid + '\'>\
    ...
    <wsse:UsernameToken xmlns:wsu=\'http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd\' wsu:Id=\'SecurityToken-' + guid + '\'>\
       ...
       <wsse:Password Type=\'http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-username-token-profile-1.0#PasswordDigest\'>' + PASSWORD_PLACEHOLDER + '</wsse:Password>\
    </wsse:UsernameToken>\
    </wsse:Security>';
  }
  else {
