 ...
 * @private
 * @param {Authority.InstanceDiscoveryCallback}   callback    The callback function.  If successful,
...
Authority.prototype._performDynamicInstanceDiscovery = function(callback) {
  try {
    ...
    this._log.verbose('Attempting instance discovery at: ' + url.format(discoveryEndpoint));
