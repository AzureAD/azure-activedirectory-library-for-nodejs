...
function Authority(authorityUrl, validateAuthority) {
  ...
  this._isTestAuthorityUrl = this._url.hostname === 'localhost'
  this._validateAuthorityUrl();

  this._validated = this._isTestAuthorityUrl || !validateAuthority;
  this._host = null;
  this._tenant = null;
  this._parseAuthority();

  this._authorizationEndpoint = this._isTestAuthorityUrl ? this._url : null;
  this._tokenEndpoint = this._isTestAuthorityUrl ? this._url : null;
  this._deviceCodeEndpoint = this._isTestAuthorityUrl ? this._url : null;
