...
var Constants = {
  OAuth2 : {
      Parameters : {
        ...
        LANGUAGE : 'mkt', // TODO: check with the names
        DEVICE_CODE : 'device_code', // TODO
      },
    ...
    // TODO: need to make sure with ests about the actual return fields
    ...
    AADConstants : {
      ...
      //TODO: remove 10.121.217.12
      WELL_KNOWN_AUTHORITY_HOSTS : ['login.windows.net', 'login.microsoftonline.com', 'login.chinacloudapi.cn', 'login.cloudgovapi.us', '10.121.217.12'],
