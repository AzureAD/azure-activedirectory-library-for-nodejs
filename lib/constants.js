...
var Constants = {
  OAuth2 : {
    ...
    AADConstants : {
      ...
      INSTANCE_DISCOVERY_ENDPOINT_TEMPLATE : 'https://{authorize_host}/common/discovery/v2.0/instance?authorization_endpoint={authorize_endpoint}&api-version=1.0',
      AUTHORIZE_ENDPOINT_PATH : '/oauth2/v2.0/authorize',
