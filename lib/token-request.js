 ...
 */
function TokenRequest(callContext, authenticationContext, clientId, scope, redirectUri) {
...
TokenRequest.prototype._createOAuthParameters = function(grantType) {
  ...
  // needs to convert the array of scope into a string delimited by space. 
