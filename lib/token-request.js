...
TokenRequest.prototype._createJwt = function(authorityUrl, certificate, thumbprint, callback) {
  var jwt;
  try {
    var ssj = new SelfSignedJwt(this._callContext, authorityUrl, this._clientId);
...
TokenRequest.prototype.getTokenWithCertificate = function(certificate, thumbprint, callback) {
  ...
  var jwt = this._createJwt(authorityUrl, certificate, thumbprint, callback);
