...
TokenRequest.prototype._getTokenWithTokenResponse = function(entry, resource, callback) {
  ...
  this._getTokenWithRefreshToken(refreshToken, resource, callback);
};
 ...
 * @param  {AcquireTokenCallback} callback
 */
TokenRequest.prototype._getTokenWithRefreshToken = function(refreshToken, resource, callback) {
 ...
 * @param  {AcquireTokenCallback} callback
 */
TokenRequest.prototype.getTokenWithRefreshToken = function(refreshToken, callback) {
  this._getTokenWithRefreshToken(refreshToken, null, callback);
};
