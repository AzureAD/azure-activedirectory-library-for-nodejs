...
TokenRequest.prototype._getTokenUsernamePasswordFederated = function(username, password, callback) {
  ...
  if (!this._userRealm.federationMetadataUrl) {
    ...
    this._performUsernamePasswordForAccessTokenExchange(this._userRealm.federationActiveAuthUrl, constants.WSTrustVersion.UNDEFINED, username, password, callback);
    return;
  } else {
    ...
    mex.discover(function(mexErr) {
      var wstrustEndpoint;
      var wstrustVersion = constants.WSTrustVersion.UNDEFINED;
      if (mexErr) {
